...
a1 <- c('soda','cheese','pretzels','beer') # beer
a2 <- c('world', 'universe','best','most') # world
a3 <- c('bluest','saddest', 'smelliest', 'happiest') # happiest
a4 <- c('crowd', 'defense', 'referees', 'players') # defense
a5 <- c('grocery','beach','mall','movies') # movies?
a6 <- c('horse', 'way', 'motorcycle', 'phone') # way
a7 <- c('years', 'thing' ,'time', 'weeks') # time
