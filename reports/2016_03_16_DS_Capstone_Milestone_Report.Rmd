...
```{r, words_frequency, cache=TRUE, warning=FALSE, message=FALSE, echo=FALSE}
library(slam)
...
As expected the frequency of 2-grams and 3-grams is much lower than the frequency of 1-grams (or words), but the numbers of 2-grams or 3-grams is extremely higer. Let's plot these values.
